      ...
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 shrink-0 overflow-hidden rounded-full">
            ...
            <img src={post.user.image || '/images/default-profile.png'} alt={post.user.name} className="h-full w-full object-cover" />
          </div>
          <div>
        ...
        <button className="rounded-md p-2 hover:bg-black/5 dark:hover:bg-white/5">
